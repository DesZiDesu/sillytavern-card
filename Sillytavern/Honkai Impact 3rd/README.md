...
The browser gallery remains in [`hi3-portraits/`](hi3-portraits/), while the materialized image files are in [`Gallery/`](Gallery/). The browser gallery is linked through `assets/galleries/`.
